    ...
    return Directionality(
      ...
      child: Scaffold(
        ...
        bottomNavigationBar: Container(
          decoration: const BoxDecoration(border: Border(top: BorderSide(color: Color(0xffE6E6E6), width: 1))),
          height: 65,
                ...
                (index) => BottomNavigationBarItem(
                    activeIcon: SizedBox(
                      ...
                      child: Column(
                        children: [
                          ...
                          Text(
                            titles[index],
                            style: Theme.of(context).textTheme.bodyMedium!.copyWith(fontSize: 12, color: Theme.of(context).primaryColor),
                          )
                        ],
                      ),
                    ),
                    ...
                    icon: Column(
                      children: [
                        ...
                        Text(
                          titles[index],
                          style: Theme.of(context).textTheme.bodyMedium!.copyWith(fontSize: 12, color: const Color(0xff959595)),
                        )
                      ],
                    ))),
          ),
