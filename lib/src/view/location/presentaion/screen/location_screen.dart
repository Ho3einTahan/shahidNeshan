...
class _LocationScreenState extends State<LocationScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: FlutterMap(options: const MapOptions(initialCenter: LatLng(33.98308, 51.43644), initialZoom: 13), children: [
        TileLayer(
        ...
        child: Stack(
          children: [
            ...
            Container(
                ...
                child: ClipRRect(borderRadius: BorderRadius.circular(100), child: Image.network("https://old.aviny.com/album/tasvir-sazi/shakhes/kamel/40.jpg", fit: BoxFit.cover)))
          ],
        ),
      );
}
